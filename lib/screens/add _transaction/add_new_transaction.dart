...
class AddNewTrasaction extends StatefulWidget {
  const AddNewTrasaction({super.key});

  @override
  State<AddNewTrasaction> createState() => _AddNewTrasactionState();
}

class _AddNewTrasactionState extends State<AddNewTrasaction> {
        ...
        child: SingleChildScrollView(
          child: Stack(
            children: [
              ...
              Padding(
                padding:
                    const EdgeInsets.only(top: 40.0, left: 20.0, bottom: 15.0),
                child: Column(
